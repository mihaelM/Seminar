...
def create_one(line, original):
    #jos bi tu trebalo sve originale stavit na nulu..
...
def solve():
    ...
    read_from_file (original)
   # print original[0:1000]
    matrix = Script1.give_matrix_from_txt()


    final_vector = calculate (original, matrix)
    print final_vector
    print_statistic(final_vector)
    return
solve()