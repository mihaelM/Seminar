...
def read_data_and_create_matrix(links):
    ...
    for link in links:
        ...
        kmers = slide(data, 10)          #kmers size 10

        arr = [0 for i in xrange(pow(4, 10))] #array with 4^10 zeroes
        for kmer in kmers :
